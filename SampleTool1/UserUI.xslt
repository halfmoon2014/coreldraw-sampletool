...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="//commandBarData[@guid='7c905e2a-cb64-4ba1-aff0-c306f392680c']/toolbar">
    <xsl:apply-templates mode="insert-item" select=".">
      <xsl:with-param name="content">
        <xsl:if test="not(./item[@guidRef='b321fc93-9672-456e-9a18-2ba25c8e89cc'])">
          <!-- Only insert if its not already there -->
          <item guidRef="b321fc93-9672-456e-9a18-2ba25c8e89cc"/>
        </xsl:if>
      </xsl:with-param>
    </xsl:apply-templates>
  </xsl:template>
  ...
  <xsl:template match="uiConfig/commandBars/commandBarData[@guid='74e03d83-404c-49f5-824a-fe0fd02ab29a']/toolbar">
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
      <modeData guid="b974bcb6-8dd2-45e3-9167-c7d3b4706d6c" captionRef="01965a34-ae38-01a0-4271-cd903b48e518">
